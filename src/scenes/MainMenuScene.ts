...
export class MainMenuScene extends Phaser.Scene {
    ...
    private menuOptions = [
        ...
        { label: 'ONLINE DEMO', mode: 'online_demo' }
    ];
    ...
    private selectOption(inputType: 'KEYBOARD' | 'GAMEPAD' = 'KEYBOARD', gamepadIndex: number | null = null): void {
        ...
        if (mode === 'online_demo') {
            this.scene.start('LobbyScene', { mode: 'online', inputType: inputType, gamepadIndex: gamepadIndex });
        } else if (mode === 'online_test') {
            this.scene.start('OnlineTestScene');
        } else {
