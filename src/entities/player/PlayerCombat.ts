...
export class PlayerCombat {
    ...
    private shouldSpawnGhost(): boolean {
        ...
        // All characters have upward ghost on neutral/up
    ...
    private updateGhostEffect(): void {
        ...
        const isVertical = (dir === AttackDirection.UP || dir === AttackDirection.NEUTRAL) && ['pe', 'nock', 'fok', 'sgu', 'sga', 'greg'].includes(char);
