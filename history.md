...
| `v0.6.5` | **Fly.io Deployment** | 2026-02-06 | Configured for production deployment on Fly.io. <br> ↳ **URL**: [sgalalla-geckos.fly.dev](https://sgalalla-geckos.fly.dev) <br> ↳ **New**: Environment-aware `NetworkManager` (auto-connect to Fly.io) <br> ↳ **New**: UDP Service support in `fly.toml` (Port 3000) <br> ↳ **Tech**: Unified server port to 3000 (standard Fly.io port) |
