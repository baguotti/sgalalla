...
| `v0.6.15` | **Production Connectivity** | 2026-02-06 | Final fix for Fly.io UDP restrictions using TURN relay. <br> ↳ **New**: Implemented TURN relay (metered.ca) <br> ↳ **New**: Forced `iceTransportPolicy: 'relay'` <br> ↳ **Fix**: Resolved NAT traversal issues for production clients |
